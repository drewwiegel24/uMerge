...
class chatbot():
    ...
    def answer_query_with_gpt4(self, question: str, query_embeddings: dict, df: pd.DataFrame, context_embeddings: dict, separator_len: int, show_prompt: bool):
        messages = [{"role" : "system", "content" : "You are a GDPR chatbot, only answer the question by using the provided context. If your are unable to answer the question using the provided context, say 'I don't know'"}]
    ...
    # def call_gpt4(self, question: str):
    #     combined_ids = self.get_relevant_combined_ids(question)
    #     self.answer_query_with_gpt4(question, self.query)
